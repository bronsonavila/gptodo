...
2. Treat each potential item line (from step 1) as separate by default. Combine a line with the preceding one if it's clear they belong to the same item, such as when:
   a) The current line is indented relative to the preceding line.
   b) The current line continues a sentence from the preceding line.
   c) The current line elaborates on or provides details for the preceding line.
   Do NOT combine distinct, self-contained items that are merely stacked vertically.
